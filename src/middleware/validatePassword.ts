...
const validatePassword = (req: Request, res: Response, next: NextFunction): void | Response => {
    ...
    return next(); // Password is valid; proceed to the next middleware or controller
};
